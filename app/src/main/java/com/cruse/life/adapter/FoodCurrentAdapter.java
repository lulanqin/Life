 ...
 */
public class FoodCurrentAdapter extends SimpleBaseAdapter<FoodTypeListBean.TngouBean> {

    String name;
    GlideRoundTransform roundTransform;

    public FoodCurrentAdapter(Context c, List<FoodTypeListBean.TngouBean> datas) {
        super(c, datas);
